...
public class From_ChonGhe extends JPanel {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					From_ChonGhe frame = new From_ChonGhe();
	...
	public From_ChonGhe() {
		...
		JButton btnNewButton = new JButton("Quoay lại");
		btnNewButton.setIcon(new ImageIcon("src\\img\\return.png"));
		...
		lblNewLabel_3.setIcon(new ImageIcon("src\\img\\BongNgo1.jpg"));
		...
		lblNewLabel_3_1.setIcon(new ImageIcon("src\\img\\BongNgo2.jpg"));
		...
		lblNewLabel_3_1_1.setIcon(new ImageIcon("src\\img\\Snack.jpg"));
		...
		lblNewLabel_3_1_1_1.setIcon(new ImageIcon("src\\img\\CoCa.jpg"));
