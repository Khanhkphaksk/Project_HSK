...
public class From_danhSachPhim extends JPanel implements ActionListener {
...
//		JSeparator separator = new JSeparator(SwingConstants.HORIZONTAL);
		...
		textTimPHim.setFont(new Font("Tahoma", Font.PLAIN, 20));
	...
	public void actionPerformed(ActionEvent e) {
	    ...
	    if (o.equals(btnDatVe1)) {
	        System.out.println("Phim Mộ Đom Đóm được chọn");
	        
	        // Xóa toàn bộ nội dung cũ và thêm giao diện mới
	        contentPane.removeAll();
	        contentPane.add(new From_ThongTinPhim1(), BorderLayout.CENTER);
